            ...
            <Carousel>
                {
                    projetsList.map((projet, i) => {
                        return (
                            <ProjectsCard key={projet.projet}>
                                ...
                                <ProjectsCardFooter>
                                        <ProjectsCardLink style={{ display: projet.git === "" ? "none" : "#3ABF70" }} href={projet.git}>Lien Github</ProjectsCardLink>
                                        <ProjectsCardLink style={{ display: projet.website === "" ? "none" : "#3ABF70" }} href={projet.website}>Site</ProjectsCardLink>
                                    </ProjectsCardFooter>
                                <ProjectsCardDetails>
